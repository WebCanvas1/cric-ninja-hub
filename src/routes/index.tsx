  ...
  return (
    <SiteLayout>
      <section className="relative overflow-hidden bg-hero">
        ...
        <div className="relative z-10 mx-auto grid max-w-7xl gap-10 px-4 py-20 sm:px-6 md:grid-cols-2 md:items-center md:py-28">
          <div className="relative z-20">
            ...
            <div className="relative z-30 mt-8 flex flex-wrap gap-3">
              <Link
                to="/shop"
                className="inline-flex cursor-pointer items-center gap-2 rounded-sm bg-primary px-7 py-4 text-sm font-bold uppercase tracking-widest text-primary-foreground shadow-red transition-all hover:brightness-110"
              >
              ...
              <Link
                to="/shop"
                className="inline-flex cursor-pointer items-center gap-2 rounded-sm border border-border bg-card px-7 py-4 text-sm font-bold uppercase tracking-widest hover:border-primary hover:text-primary"
              >
                View Collection
              </Link>
            </div>
          ...
          <div className="relative z-10">
            <div className="pointer-events-none absolute -inset-6 rounded-full bg-primary/20 blur-3xl" />
            <div className="relative aspect-square overflow-hidden rounded-full border-2 border-primary/30 shadow-red">
              <img
                src={content.hero.image || LOGO_URL}
                alt="CRIC NINJA"
      ...
      <section className="mx-auto max-w-7xl px-4 py-20 sm:px-6">
        <div className="mb-10 flex items-end justify-between">
          <div>
            ...
            <h2 className="display mt-2 text-4xl font-bold uppercase tracking-wider sm:text-5xl">
              Featured Bats
            </h2>
          </div>
          <Link
            to="/shop"
            className="hidden text-sm font-bold uppercase tracking-widest text-primary hover:underline sm:inline-flex"
          >
            View All →
          </Link>
        </div>
          ...
          <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
            {content.whyChooseUs.map((f, i) => {
              ...
              return (
                <div
                  key={i}
                  className="group rounded-md border border-border bg-background p-6 transition-all hover:border-primary hover:shadow-red"
                >
                  ...
                  <h3 className="display text-lg font-bold uppercase tracking-wide">
                    {f.title}
                  </h3>
      ...
      <section className="mx-auto grid max-w-7xl gap-12 px-4 py-20 sm:px-6 md:grid-cols-2 md:items-center">
        <div className="relative aspect-[4/5] overflow-hidden rounded-md bg-secondary shadow-card">
          ...
          <div className="absolute bottom-6 left-6 right-6">
            ...
            <div className="display mt-1 text-2xl font-bold">
              Melbourne, Australia — Home of CRIC NINJA
            </div>
          </div>
        </div>
        ...
        <div>
          ...
          <h2 className="display mt-2 text-4xl font-bold uppercase leading-tight tracking-wider sm:text-5xl">
            {content.about.title}
          </h2>
      ...
      <section className="mx-auto max-w-7xl px-4 py-20 sm:px-6">
        <div className="relative overflow-hidden rounded-md border border-primary/40 bg-gradient-to-br from-card via-card to-primary/20 p-10 text-center shadow-red sm:p-16">
          <h2 className="display text-4xl font-bold uppercase tracking-wider sm:text-5xl">
            Ready to <span className="text-gradient-red">Strike</span>?
          </h2>
          <p className="mx-auto mt-4 max-w-xl text-muted-foreground">
            Find the blade that matches your game. Free knock-in, free shipping on
            all orders above $150.
          </p>
          <Link
            to="/shop"
            className="mt-8 inline-flex items-center gap-2 rounded-sm bg-primary px-8 py-4 text-sm font-bold uppercase tracking-widest text-primary-foreground hover:brightness-110"
          >
